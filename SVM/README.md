Q2: I implement SVM in the primal domain in SVM_Primal_Domain.ipynb file. I use the schedule_type=0, or 1 to represent the two different schedule of learning rate.
